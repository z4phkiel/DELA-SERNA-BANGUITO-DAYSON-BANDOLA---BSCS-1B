...
public class DcitPaint extends Frame {
    private int x = -1, y = -1; // Initial coordinates
    private Image img;
    private Graphics imgGraphics;
    private Color currentColor = Color.BLACK; // Initial drawing color
    private final int eraserSize = 20; // Size of the eraser
    private boolean eraserActive = false; // Indicates if the eraser is active
    ...
    public DcitPaint() {
        ...
        colorPanel.setLayout(new FlowLayout()); // Use FlowLayout for automatic button arrangement
    ...
    public void paint(Graphics g) {
        g.drawImage(img, 0, 0, this); // Draw the off-screen image onto the screen
    }
